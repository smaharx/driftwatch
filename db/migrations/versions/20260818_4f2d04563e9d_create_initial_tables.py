...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "feature_names", postgresql.JSON(astext_type=sa.Text()), nullable=False
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "distribution", postgresql.JSON(astext_type=sa.Text()), nullable=False
        ),
    ...
    op.create_index(
        op.f("ix_baselines_model_id"), "baselines", ["model_id"], unique=False
    )
    op.create_table(
        "runs",
        sa.Column("id", sa.String(length=36), nullable=False),
        ...
        sa.Column("sample_size", sa.Integer(), nullable=False),
        sa.Column(
            "drift_results", postgresql.JSON(astext_type=sa.Text()), nullable=True
        ),
        sa.Column("overall_drift_score", sa.Float(), nullable=True),
        sa.Column(
            "drifted_features", postgresql.JSON(astext_type=sa.Text()), nullable=True
        ),
